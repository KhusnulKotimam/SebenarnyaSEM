    ...
    <div class="bg-gradient-to-tr from-blue-100 via-purple-100 to-pink-100 rounded-2xl shadow-xl p-8">
        ...
        @forelse($inquiries as $inquiry)
            <div class="border border-gray-300 rounded-lg mb-6 p-5 shadow-md bg-white">
                ...
                <div class="mb-4">
                    ...
                    <p class="text-sm text-gray-600">
                        ...
                        <span class="font-medium">
                            {{ $inquiry->publicUser->user->name ?? 'Unknown' }}
                        </span>
                    </p>
                    ...
                    <p class="text-sm text-gray-600">
                        Assigned to:
                        <span class="font-medium">
                            {{ $inquiry->agency->user->name ?? 'Unknown Agency' }}
                        </span>
                    </p>
                ...
                <div class="mt-4">
                    ...
                    @forelse($inquiry->progressUpdates->sortBy('created_at') as $progress)
                        <div class="relative pl-8 pb-6 border-l-2 border-indigo-300">

                            <div class="absolute -left-2 top-1 w-4 h-4 bg-indigo-500 rounded-full"></div>
                            ...
                            @if($progress->SupportingDocument)
                                <p class="text-xs mt-2">
                                    <a href="{{ asset('storage/' . $progress->SupportingDocument) }}"
                                       target="_blank"
        ...
        @empty
            <p class="text-center text-gray-600">
                No inquiries have been assigned yet.
            </p>
        @endforelse
