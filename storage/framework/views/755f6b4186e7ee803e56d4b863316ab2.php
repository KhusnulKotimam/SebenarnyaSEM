...
<div class="py-12">
    <div class="bg-gradient-to-tr from-blue-100 via-purple-100 to-pink-100 rounded-2xl shadow-xl p-8">
        <!-- <div class="bg-gradient-to-tr from-blue-100 via-purple-100 to-pink-100 rounded-2xl shadow-xl p-8"> -->
            <h2 class="text-2xl font-bold mb-6 text-gray-800">Welcome, <?php echo e(Auth::user()->name); ?> (MCMC)!</h2>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-yellow-100 p-6 rounded-lg shadow text-center">
                    <div class="text-3xl font-bold text-yellow-600 mb-2"><?php echo e($assigned); ?></div>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $recent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="transition hover:bg-blue-50">
                                    <td class="px-4 py-2 text-gray-700 font-semibold"><?php echo e($inquiry->NewsTitle); ?></td>
                                    <td class="px-4 py-2">
                                    ...
                                    <td class="px-4 py-2 text-gray-500"><?php echo e(\Carbon\Carbon::parse($inquiry->created_at)->format('d M Y')); ?></td>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Laravel\SebenarnyaSEM\resources\views/MCMC/dashboard.blade.php ENDPATH**/ ?>